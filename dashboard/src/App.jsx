...
const METRICS = {
  ...
  craftScore:     { name: 'Craft Score',         icon: '🎨', unit: '',   dir: 'higher', green: 7,   yellow: 5,  agg: 'avg', desc: 'Avg editor craft score (÷10 feeds the index). Note: mixes in editor education — open question whether it belongs in the index.' },
  ...
  reliability:    { name: 'Reliability',          icon: '🛡️', unit: '%', dir: 'higher', green: 95, yellow: 90, agg: 'avg', desc: 'Tool runs without error (successful ÷ attempts). Saskia’s metric. Tracked alongside; separate from revisions. Data pending.' },
