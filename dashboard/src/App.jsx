...
const METRICS = {
  ...
  craftScore:     { name: 'Craft Score',         icon: '🎨', unit: '',   dir: 'higher', green: 7,   yellow: 5,  agg: 'avg', desc: 'Avg editor craft score (÷10), IN the index per Alan (CX call). Reflects editing craft; read the tool's own signals (revisions, reliability) alongside it.' },
