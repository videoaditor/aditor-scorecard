...
const METRICS = {
  ...
  editorChurn:    { name: 'Editor Churn',      icon: '📉', unit: '%',  dir: 'lower',  green: 1, yellow: 3, agg: 'last', desc: 'Active editors who completed no card in the last 90 days OR are no longer in Slack, divided by all active editors (a never-activated hire counts as churned - onboarding cost, no output). Point-in-time each week. green <=1%, yellow 1-3%, red >3%.' },
